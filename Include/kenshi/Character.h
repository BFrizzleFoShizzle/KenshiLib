...
public:
    ...
    virtual bool isOnARoof() override;// public RVA = 0x5E16E0 vtable offset = 0x0
    ...
    virtual itemType getDataType() const override;// public RVA = 0x5E1730 vtable offset = 0x0
    ...
    virtual bool takeMoney(int n) override;// public RVA = 0x795390 vtable offset = 0x0
    bool _NV_takeMoney(int n);// public RVA = 0x795390 vtable offset = 0x0
    virtual int getMoney() const override;// public RVA = 0x790400 vtable offset = 0x0
    ...
    virtual SensoryData* getSensoryData() override;// public RVA = 0x5C7F80 vtable offset = 0x0
    SensoryData* _NV_getSensoryData();// public RVA = 0x5C7F80 vtable offset = 0x0
    virtual StateBroadcastData* getStateBroadcast() override;// public RVA = 0x5E1750 vtable offset = 0x0
    ...
    virtual void setHandle(const hand& h) override;// public RVA = 0x6231A0 vtable offset = 0x0
    void _NV_setHandle(const hand& h);// public RVA = 0x6231A0 vtable offset = 0x0
    virtual void update() override;// public RVA = 0x5CE9B0 vtable offset = 0x0
    ...
    virtual void periodicUpdate() override;// public RVA = 0x5CC610 vtable offset = 0x0
    ...
    virtual void threadedUpdate() override;// public RVA = 0x5C74B0 vtable offset = 0x0
    ...
    virtual bool stolenGoodsDetectionCheck(Item* item, RootObject* thief) override;// public RVA = 0x792510 vtable offset = 0x0
    ...
    virtual GameSaveState serialise(GameDataContainer* container, GameData* refList, PosRotPair* offsetPosToSubtract) override;// public RVA = 0x627920 vtable offset = 0x0
    ...
    virtual void loadFromSerialise(GameSaveState* state) override;// public RVA = 0x6267D0 vtable offset = 0x0
    ...
    virtual Ogre::Vector3 getPosition() override;// public RVA = 0x5CDF00 vtable offset = 0x0
    ...
    virtual float getMovementSpeed() const override;// public RVA = 0x5C7C50 vtable offset = 0x0
    ...
    virtual Ogre::Vector3 getMovementDirection() const override;// public RVA = 0x5C7CB0 vtable offset = 0x0
    Ogre::Vector3 _NV_getMovementDirection() const;// public RVA = 0x5C7CB0 vtable offset = 0x0
    // no_addr int getSquadMemberID();// public
    virtual bool isPhysical() const override;// public RVA = 0x5C8040 vtable offset = 0x0
    bool _NV_isPhysical() const;// public RVA = 0x5C8040 vtable offset = 0x0
    virtual void setVisible(bool on) override;// public RVA = 0x5C8070 vtable offset = 0x0
    void _NV_setVisible(bool on);// public RVA = 0x5C8070 vtable offset = 0x0
    virtual bool getVisible() const override;// public RVA = 0x5C8100 vtable offset = 0x0
    bool _NV_getVisible() const;// public RVA = 0x5C8100 vtable offset = 0x0
    void switchLights(bool on);// public RVA = 0x52C580
    virtual bool isDisabled() override;// public RVA = 0x5C8130 vtable offset = 0x0
    bool _NV_isDisabled();// public RVA = 0x5C8130 vtable offset = 0x0
    virtual void setInsideTownWalls(int s) override;// public RVA = 0x790D80 vtable offset = 0x0
    ...
    virtual void select() override;// public RVA = 0x5C8D70 vtable offset = 0x0
    void _NV_select();// public RVA = 0x5C8D70 vtable offset = 0x0
    virtual void unselect() override;// public RVA = 0x5C8DA0 vtable offset = 0x0
    void _NV_unselect();// public RVA = 0x5C8DA0 vtable offset = 0x0
    virtual void getGUIData(DatapanelGUI* datapanel, int category) override;// public RVA = 0x5D3AE0 vtable offset = 0x0
    void _NV_getGUIData(DatapanelGUI* datapanel, int category);// public RVA = 0x5D3AE0 vtable offset = 0x0
    virtual TownBase* getCurrentTownLocation() override;// public RVA = 0x5C8230 vtable offset = 0x0
    ...
    virtual void say(const std::string& s) override;// public RVA = 0x5C91D0 vtable offset = 0x0
    ...
    virtual bool giveItem(Item* item, bool dropOnFail, bool destroyOnFail) override;// public RVA = 0x5CAC80 vtable offset = 0x0
    bool _NV_giveItem(Item* item, bool dropOnFail, bool destroyOnFail);// public RVA = 0x5CAC80 vtable offset = 0x0
    virtual bool hasRoomForItem(GameData* item) override;// public RVA = 0x5CADA0 vtable offset = 0x0
    bool _NV_hasRoomForItem(GameData* item);// public RVA = 0x5CADA0 vtable offset = 0x0
    virtual bool hasItem(GameData* item) override;// public RVA = 0x5CAE30 vtable offset = 0x0
    ...
    virtual Inventory* getInventory() const override;// public RVA = 0x5E1760 vtable offset = 0x0
    ...
    virtual InventoryLayout* createInventoryLayout() override;// public RVA = 0x5CB1F0 vtable offset = 0x0
    ...
    virtual const Ogre::Aabb& getAABB() const override;// public RVA = 0x5C87D0 vtable offset = 0x0
    ...
    virtual const hand& isIndoors() const override;// public RVA = 0x5CD8A0 vtable offset = 0x0
    ...
    virtual void notifyIndoors(const hand& in) override;// public RVA = 0x7910B0 vtable offset = 0x0
    ...
    virtual float getIntendedAggression() override;// public RVA = 0x598410 vtable offset = 0x0
    float _NV_getIntendedAggression();// public RVA = 0x598410 vtable offset = 0x0
    Ogre::Vector3 getPositionBip01();// public RVA = 0x2ADB60
    virtual int amInsideTownWalls() override;// public RVA = 0x790FA0 vtable offset = 0x0
    int _NV_amInsideTownWalls();// public RVA = 0x790FA0 vtable offset = 0x0
    virtual void setName(const std::string& name) override;// public RVA = 0x5CBB50 vtable offset = 0x0
    ...
    virtual bool isUnconcious() const override;// public RVA = 0x5C9690 vtable offset = 0x0
    ...
    virtual HitMaterialType hitByMeleeAttack(CutDirection dir, Damages& damage, Character* who, CombatTechniqueData* attack, int comboID) override;// public RVA = 0x438D70 vtable offset = 0x0
    ...
    virtual void setFaction(Faction* p, ActivePlatoon* a) override;// public RVA = 0x5CB340 vtable offset = 0x0
    ...
    virtual RaceData* getRace() const override;// public RVA = 0x5E1780 vtable offset = 0x0
    ...
    virtual void notifyEffect(EffectType::Enum type, WeatherAffecting what, float strength) override;// public RVA = 0x5CB540 vtable offset = 0x0
    void _NV_notifyEffect(EffectType::Enum type, WeatherAffecting what, float strength);// public RVA = 0x5CB540 vtable offset = 0x0
    virtual void equipItem(const std::string& sectionName, Item* item) override;// public RVA = 0x5DB600 vtable offset = 0x0
    void _NV_equipItem(const std::string& sectionName, Item* item);// public RVA = 0x5DB600 vtable offset = 0x0
    virtual void unequipItem(const std::string& sectionName, Item* item) override;// public RVA = 0x5DBB90 vtable offset = 0x0
    ...
    virtual bool createPhysical() override;// protected RVA = 0x5CBB90 vtable offset = 0x0
    bool _NV_createPhysical();// protected RVA = 0x5CBB90 vtable offset = 0x0
    virtual void destroyPhysical() override;// protected RVA = 0x5C8D10 vtable offset = 0x0
    ...
    virtual void loadUnloadCheck() override;// protected RVA = 0x5C8C90 vtable offset = 0x0
